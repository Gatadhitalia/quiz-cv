                    ...
                    <div class="card-body">
                        <form action="{{ route('job.update', $job->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('periode_masuk_job') is-invalid @enderror" name="periode_masuk_job" value="{{ old('periode_masuk_job',$job->periode_masuk_job) }}" placeholder="Masukkan Periode Masuk Mahasiswa">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('periode_keluar_job') is-invalid @enderror" name="periode_keluar_job" value="{{ old('periode_keluar_job',$job->periode_keluar_job) }}" placeholder="Masukkan Periode Keluar Mahasiswa">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('prov_job') is-invalid @enderror" name="prov_job" value="{{ old('prov_job',$job->prov_job) }}" placeholder="Masukkan Provinsi Instansi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('kota_job') is-invalid @enderror" name="kota_job" value="{{ old('kota_job',$job->kota_job) }}" placeholder="Masukkan Tautan/Website Instansi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('jns_job') is-invalid @enderror" name="jns_job" value="{{ old('jns_job',$job->jns_job) }}" placeholder="Masukkan Jenis Pekerjaan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('jabatan_job') is-invalid @enderror" name="jabatan_job" value="{{ old('jabatan_job',$job->jabatan_job) }}" placeholder="Masukkan Jabatan Pekerjaan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('deskripsi_job') is-invalid @enderror" name="deskripsi_job" value="{{ old('deskripsi_job',$job->deskripsi_job) }}" placeholder="Masukkan Jabatan Pekerjaan">
