                    ...
                    <div class="card-body">
                        <form action="{{ route('academic.update', $academic->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ old('nim', $academic->nim) }}" placeholder="Masukkan NIM Mahasiswa">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_mhs') is-invalid @enderror" name="nama_mhs" value="{{ old('nama_mhs', $academic->nama_mhs) }}" placeholder="Masukkan Nama Mahasiswa">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">IPK Mahasiswa</label>
