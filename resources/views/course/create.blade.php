                    ...
                    <div class="card-body">
                        <form action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tingkat_course') is-invalid @enderror" name="tingkat_course" value="{{ old('tingkat_course') }}" placeholder="Masukkan Tingkat Course">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('tahun_course') is-invalid @enderror" name="tahun_course" value="{{ old('tahun_course') }}" placeholder="Masukkan Tahun Course">
