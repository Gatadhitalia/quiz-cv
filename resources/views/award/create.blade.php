                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('award.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Nama Institusi Award</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="link" class="form-control @error('tingkat_award') is-invalid @enderror" name="tingkat_award" value="{{ old('tingkat_award') }}" placeholder="Masukkan Tingkat Award">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('tahun_award') is-invalid @enderror" name="tahun_award" value="{{ old('tahun_award') }}" placeholder="Masukkan Tingkat Award">
